...
vac_coverage_df = pd.read_csv(r"C:\MMR-py\vac coverage 2025-04-03 15-07 UTC.csv", 
                              encoding='ISO-8859-1', 
                              on_bad_lines='skip', 
                              delimiter=';')
reported_cases_df = pd.read_csv(r"C:\MMR-py\reported cases and incidence 2025-04-03 15-17 UTC INC.csv", 
                                encoding='ISO-8859-1', 
                                on_bad_lines='skip', 
                                delimiter=';')
...
layout = go.Layout(
    title='Measles vaccination coverage vs reported case incidence rate for different countries',
...
fig.write_html(r"C:\MMR-py\D) MMR vaccination_vs_reported_cases_dropdown_1980_2023.html")
