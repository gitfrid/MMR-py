...
vac_coverage_df = pd.read_csv(r"C:\github\MMR-py\vac coverage 2025-04-03 15-07 UTC.csv", 
                              encoding='ISO-8859-1', 
                              on_bad_lines='skip', 
                              delimiter=';')
reported_cases_df = pd.read_csv(r"C:\github\MMR-py\reported cases and incidence 2025-04-03 15-17 UTC INC.csv", 
                                encoding='ISO-8859-1', 
                                on_bad_lines='skip', 
                                delimiter=';')
...
layout = go.Layout(
    title=f'Measles vaccination coverage vs reported case incidence rate for different countries {year_range_text}',
            ...
            buttons=[
                ...
                dict(
                    ...
                    args=[{'visible': [True] * len(traces)},
                          {'title': 'Measles Vaccination Coverage and Reported Cases'}]
                ),
            ],
            direction='down',
            pad={'r': 10, 't': 10},
...
fig.write_html(fr"C:\github\MMR-py\D) MMR vaccination_vs_reported_cases_dropdown_{year_range_text}.html")
