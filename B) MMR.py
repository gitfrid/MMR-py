...
layout = go.Layout(
    title=f"Measles vaccination coverage vs reported case incidence rate for different countries, M-containing vac 2nd Dose<br>{slope_text} {year_range_text}",
...
fig.write_html(fr"C:\MMR-py\B) MMR {slope_text} {year_range_text}.html")
